...
namespace Cricket.Common.Net
{
    public class SocketClient
    {
        ...
        public SocketClient(INetManager<byte[]> netMgr)
        {
        ...
        void WriteMessage(byte[] message)
        {
            ...
            {
                LogKit.E("client.connected----->>false");
            }
        }
        ...
        void PrintBytes()
        {
            ...
            LogKit.I("Recv Buff: {0}", returnStr);
        }
