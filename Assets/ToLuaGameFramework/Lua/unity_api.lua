...
local AudioSource = {
    ...
    ---@type GamepadSpeakerOutputType
    gamepadSpeakerOutputType = nil,
    ---@type boolean
    isPlaying = nil,
    ---@type boolean
    isVirtual = nil,
...
---@param objA Object
---@param objB Object
function Debug.Equals(objA, objB) end
---@return boolean
---@param objA Object
---@param objB Object
function Debug.ReferenceEquals(objA, objB) end
...
Physics.improvedPatchFriction = nil
...
function Texture2D:Reinitialize(width, height, format, hasMipMap) end
---@return boolean
---@param width number
---@param height number
---@param format TextureFormat
...
Shader.enabledGlobalKeywords = nil
Shader.globalKeywords = nil
---@return Shader
---@param name string
...
---@param onEvent Action
function NetManager:RegisterReceiveEvent(onEvent) end
function NetManager:DoUpdate() end
function NetManager:DoClose() end
---@param address string
---@param port number
function NetManager:SendConnect(address, port) end
function NetManager:CloseSocket() end
---@return boolean
function NetManager:IsConnected() end
---@param buffer ByteBuffer
function NetManager:SendMessage(buffer) end
---@param bytearray Byte[]
function NetManager:AddEvent(bytearray) end
---@return boolean
---@param objA Object
---@param objB Object
function NetManager.Equals(objA, objB) end
---@return boolean
---@param objA Object
---@param objB Object
function NetManager.ReferenceEquals(objA, objB) end

---@class MsgDispatcher : Object @ ---------------------------------------------------------------
local MsgDispatcher = {
}
MsgDispatcher.Instance = nil
function MsgDispatcher:OnInit() end
---@param key string
---@param onEvent Action
function MsgDispatcher:Register(key, onEvent) end
---@param key string
---@param onEvent Action
function MsgDispatcher:UnRegister(key, onEvent) end
---@return boolean
---@param key string
---@param data Byte[]
function MsgDispatcher:Send(key, data) end
---@param bytearray Byte[]
function MsgDispatcher:Dispatcher(bytearray) end
---@return boolean
---@param objA Object
---@param objB Object
function MsgDispatcher.Equals(objA, objB) end
---@return boolean
---@param objA Object
---@param objB Object
function MsgDispatcher.ReferenceEquals(objA, objB) end

---@class MsgSender : Object @ ---------------------------------------------------------------
local MsgSender = {
}
MsgSender.Instance = nil
function MsgSender:OnInit() end
---@param name string
---@param body_data Byte[]
---@param cb Action
function MsgSender:SendMessage(name, body_data, cb) end
---@param sessionId UInt32
---@param result boolean
---@param errCode number
function MsgSender:OnCallback(sessionId, result, errCode) end
---@return boolean
---@param objA Object
---@param objB Object
function MsgSender.Equals(objA, objB) end
---@return boolean
---@param objA Object
---@param objB Object
function MsgSender.ReferenceEquals(objA, objB) end
