...
namespace ToLuaGameFramework
{
    public static class SoundManager
    {
        ...
        public static void PlaySound(string clipPath, float volume = 1, int loopTimes = 0, string loopID = null)
        {
            ...
            AudioSource audioSource = GlobalManager.Behaviour.GetComponent<AudioSource>();
            if (!audioSource) audioSource = GlobalManager.Behaviour.gameObject.AddComponent<AudioSource>();
            if (loopTimes == 0)
            {
