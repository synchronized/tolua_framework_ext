...
namespace LuaInterface.Editor
{
    ...
    {
        public static string blackListFilePath = ToLuaPathConfig.GetToLuaPath(LuaConst.injectionFilesPath) + "InjectionBlackList.txt";
        ...
        string SelectFolder()
        {
            string selectedPath = EditorUtility.OpenFolderPanel("Select Injection Path", Application.dataPath, "");
        ...
        string GetRelativePath(string absolutePath)
        {
            ...
            {
                return LuaTools.AbsolutePathToAssetPath(absolutePath);
            }
            else
            {
        ...
        void InitPathsInfo()
        {
            var injectionPath = ToLuaPathConfig.GetToLuaPath(LuaConst.injectionFilesPath);
            if (pathsInfoSavedPath == null)
            {
                pathsInfoSavedPath = injectionPath + "LuaInjectionSkipPaths.txt";
            }
            if (paths != null)
            {
                return;
            ...
            else
            {
                ...
                string toluaPath = GetRelativePath(injectionPath.Substring(0, injectionPath.Length - "Injection/".Length));
                paths.Add(toluaPath + "Core/");
                paths.Add(toluaPath + "Injection/");
                paths.Add(toluaPath + "Misc/");
                paths.Add(toluaPath + "Injection/");
                paths.Add(toluaPath + "Misc/");
                paths.Add(ToLuaPathConfig.RootPath + "/Plugins/");
                paths.Add(GetRelativePath(ToLuaPathConfig.GenCsharpPath));
            }
        }
