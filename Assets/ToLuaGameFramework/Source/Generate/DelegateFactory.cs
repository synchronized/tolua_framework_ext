...
public class DelegateFactory
{
	...
	{
		return TypeChecker.CheckDelegateType<System.Action<ToLuaGameFramework.BaseMsg>>(L, pos);
	}
	...
	{
		return TypeChecker.CheckDelegateType<System.Action<string,float,bool>>(L, pos);
	}
	...
	{
		return TypeChecker.CheckDelegateType<ToLuaGameFramework.TweenEvent>(L, pos);
	}
	...
	{
		return TypeChecker.CheckDelegateType<System.Action<float>>(L, pos);
	}
