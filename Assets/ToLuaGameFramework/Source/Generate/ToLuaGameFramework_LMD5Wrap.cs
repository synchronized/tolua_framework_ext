...
public class ToLuaGameFramework_LMD5Wrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("StirngToMD5", new LuaCSFunction(StirngToMD5));
		L.RegFunction("BytesToMD5", new LuaCSFunction(BytesToMD5));
		L.RegFunction("FileToMD5", new LuaCSFunction(FileToMD5));
		L.RegFunction("New", new LuaCSFunction(_CreateToLuaGameFramework_LMD5));
