...
public class ToLuaGameFramework_LAESWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("Encrypt", new LuaCSFunction(Encrypt));
		L.RegFunction("Decrypt", new LuaCSFunction(Decrypt));
		L.RegFunction("New", new LuaCSFunction(_CreateToLuaGameFramework_LAES));
