...
public class UnityEngine_UI_HorizontalOrVerticalLayoutGroupWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("spacing", new LuaCSFunction(get_spacing), new LuaCSFunction(set_spacing));
		L.RegVar("childForceExpandWidth", new LuaCSFunction(get_childForceExpandWidth), new LuaCSFunction(set_childForceExpandWidth));
		L.RegVar("childForceExpandHeight", new LuaCSFunction(get_childForceExpandHeight), new LuaCSFunction(set_childForceExpandHeight));
		L.RegVar("childControlWidth", new LuaCSFunction(get_childControlWidth), new LuaCSFunction(set_childControlWidth));
		L.RegVar("childControlHeight", new LuaCSFunction(get_childControlHeight), new LuaCSFunction(set_childControlHeight));
		L.RegVar("childScaleWidth", new LuaCSFunction(get_childScaleWidth), new LuaCSFunction(set_childScaleWidth));
		L.RegVar("childScaleHeight", new LuaCSFunction(get_childScaleHeight), new LuaCSFunction(set_childScaleHeight));
		L.RegVar("reverseArrangement", new LuaCSFunction(get_reverseArrangement), new LuaCSFunction(set_reverseArrangement));
		L.EndClass();
	}
