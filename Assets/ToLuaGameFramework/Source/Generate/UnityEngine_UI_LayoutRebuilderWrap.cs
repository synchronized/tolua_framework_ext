...
public class UnityEngine_UI_LayoutRebuilderWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("ForceRebuildLayoutImmediate", new LuaCSFunction(ForceRebuildLayoutImmediate));
		L.RegFunction("Rebuild", new LuaCSFunction(Rebuild));
		L.RegFunction("MarkLayoutForRebuild", new LuaCSFunction(MarkLayoutForRebuild));
		...
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_UI_LayoutRebuilder));
