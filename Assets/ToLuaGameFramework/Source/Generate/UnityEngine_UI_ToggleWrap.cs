...
public class UnityEngine_UI_ToggleWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("SetIsOnWithoutNotify", new LuaCSFunction(SetIsOnWithoutNotify));
		L.RegFunction("OnPointerClick", new LuaCSFunction(OnPointerClick));
		L.RegFunction("OnSubmit", new LuaCSFunction(OnSubmit));
		L.RegFunction("OnValueChanged", new LuaCSFunction(OnValueChanged));
		L.RegFunction("__eq", new LuaCSFunction(op_Equality));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("toggleTransition", new LuaCSFunction(get_toggleTransition), new LuaCSFunction(set_toggleTransition));
		L.RegVar("graphic", new LuaCSFunction(get_graphic), new LuaCSFunction(set_graphic));
		...
		L.RegVar("isOn", new LuaCSFunction(get_isOn), new LuaCSFunction(set_isOn));
		L.EndClass();
	}
	...
	static int set_toggleTransition(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.Toggle obj = (UnityEngine.UI.Toggle)o;
			UnityEngine.UI.Toggle.ToggleTransition arg0 = (UnityEngine.UI.Toggle.ToggleTransition)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.UI.Toggle.ToggleTransition>.type);
