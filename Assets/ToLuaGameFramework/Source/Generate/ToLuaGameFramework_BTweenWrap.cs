...
public class ToLuaGameFramework_BTweenWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("Parabola", new LuaCSFunction(Parabola));
		L.RegFunction("StopParabola", new LuaCSFunction(StopParabola));
		L.RegFunction("Swing", new LuaCSFunction(Swing));
		L.RegFunction("StopSwing", new LuaCSFunction(StopSwing));
		L.RegFunction("Value", new LuaCSFunction(Value));
		L.RegFunction("Linear", new LuaCSFunction(Linear));
		L.RegFunction("Ease", new LuaCSFunction(Ease));
		L.RegFunction("New", new LuaCSFunction(_CreateToLuaGameFramework_BTween));
	...
	static int Value(IntPtr L)
	{
		try
		{
			...
			if (count == 6)
			{
				...
				float arg2 = (float)LuaDLL.luaL_checknumber(L, 3);
				float arg3 = (float)LuaDLL.luaL_checknumber(L, 4);
				ToLuaGameFramework.BEaseType arg4 = (ToLuaGameFramework.BEaseType)ToLua.CheckObject(L, 5, TypeTraits<ToLuaGameFramework.BEaseType>.type);
