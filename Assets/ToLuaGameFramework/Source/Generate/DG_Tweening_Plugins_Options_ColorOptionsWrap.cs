...
public class DG_Tweening_Plugins_Options_ColorOptionsWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", new LuaCSFunction(_CreateDG_Tweening_Plugins_Options_ColorOptions));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("alphaOnly", new LuaCSFunction(get_alphaOnly), new LuaCSFunction(set_alphaOnly));
		L.EndClass();
	}
	...
	static int Reset(IntPtr L)
	{
		try
		{
			...
			DG.Tweening.Plugins.Options.ColorOptions obj = (DG.Tweening.Plugins.Options.ColorOptions)ToLua.CheckObject(L, 1, TypeTraits<DG.Tweening.Plugins.Options.ColorOptions>.type);
			obj.Reset();
