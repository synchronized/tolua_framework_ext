...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.RegFunction("TweenEvent", new LuaCSFunction(ToLuaGameFramework_TweenEvent));
		L.EndModule();
		...
		L.RegFunction("Action_ToLuaGameFramework_BaseMsg", new LuaCSFunction(System_Action_ToLuaGameFramework_BaseMsg));
		L.RegFunction("Action_string_float_bool", new LuaCSFunction(System_Action_string_float_bool));
		L.RegFunction("Action_float", new LuaCSFunction(System_Action_float));
		L.RegFunction("Action_bytes", new LuaCSFunction(System_Action_bytes));
		L.RegFunction("Action_bool_int", new LuaCSFunction(System_Action_bool_int));
		L.EndModule();
		L.EndModule();
		L.BeginPreLoad();
