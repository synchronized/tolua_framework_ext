...
public class UnityEngine_ParticleSystemWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("SetParticles", new LuaCSFunction(SetParticles));
		L.RegFunction("GetParticles", new LuaCSFunction(GetParticles));
		L.RegFunction("SetCustomParticleData", new LuaCSFunction(SetCustomParticleData));
		L.RegFunction("GetCustomParticleData", new LuaCSFunction(GetCustomParticleData));
		L.RegFunction("GetPlaybackState", new LuaCSFunction(GetPlaybackState));
		L.RegFunction("SetPlaybackState", new LuaCSFunction(SetPlaybackState));
		L.RegFunction("GetTrails", new LuaCSFunction(GetTrails));
		L.RegFunction("SetTrails", new LuaCSFunction(SetTrails));
		...
		L.RegFunction("IsAlive", new LuaCSFunction(IsAlive));
		L.RegFunction("Emit", new LuaCSFunction(Emit));
		L.RegFunction("TriggerSubEmitter", new LuaCSFunction(TriggerSubEmitter));
		L.RegFunction("ResetPreMappedBufferMemory", new LuaCSFunction(ResetPreMappedBufferMemory));
		L.RegFunction("SetMaximumPreMappedBufferCounts", new LuaCSFunction(SetMaximumPreMappedBufferCounts));
		L.RegFunction("AllocateAxisOfRotationAttribute", new LuaCSFunction(AllocateAxisOfRotationAttribute));
		L.RegFunction("AllocateMeshIndexAttribute", new LuaCSFunction(AllocateMeshIndexAttribute));
		L.RegFunction("AllocateCustomDataAttribute", new LuaCSFunction(AllocateCustomDataAttribute));
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_ParticleSystem));
		L.RegFunction("__eq", new LuaCSFunction(op_Equality));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("isPlaying", new LuaCSFunction(get_isPlaying), null);
		L.RegVar("isEmitting", new LuaCSFunction(get_isEmitting), null);
		L.RegVar("isStopped", new LuaCSFunction(get_isStopped), null);
		L.RegVar("isPaused", new LuaCSFunction(get_isPaused), null);
		L.RegVar("particleCount", new LuaCSFunction(get_particleCount), null);
		L.RegVar("time", new LuaCSFunction(get_time), new LuaCSFunction(set_time));
		L.RegVar("randomSeed", new LuaCSFunction(get_randomSeed), new LuaCSFunction(set_randomSeed));
		L.RegVar("useAutoRandomSeed", new LuaCSFunction(get_useAutoRandomSeed), new LuaCSFunction(set_useAutoRandomSeed));
		L.RegVar("proceduralSimulationSupported", new LuaCSFunction(get_proceduralSimulationSupported), null);
		L.RegVar("main", new LuaCSFunction(get_main), null);
		L.RegVar("emission", new LuaCSFunction(get_emission), null);
		L.RegVar("shape", new LuaCSFunction(get_shape), null);
		L.RegVar("velocityOverLifetime", new LuaCSFunction(get_velocityOverLifetime), null);
		L.RegVar("limitVelocityOverLifetime", new LuaCSFunction(get_limitVelocityOverLifetime), null);
		L.RegVar("inheritVelocity", new LuaCSFunction(get_inheritVelocity), null);
		L.RegVar("lifetimeByEmitterSpeed", new LuaCSFunction(get_lifetimeByEmitterSpeed), null);
		L.RegVar("forceOverLifetime", new LuaCSFunction(get_forceOverLifetime), null);
		L.RegVar("colorOverLifetime", new LuaCSFunction(get_colorOverLifetime), null);
		L.RegVar("colorBySpeed", new LuaCSFunction(get_colorBySpeed), null);
		L.RegVar("sizeOverLifetime", new LuaCSFunction(get_sizeOverLifetime), null);
		L.RegVar("sizeBySpeed", new LuaCSFunction(get_sizeBySpeed), null);
		L.RegVar("rotationOverLifetime", new LuaCSFunction(get_rotationOverLifetime), null);
		L.RegVar("rotationBySpeed", new LuaCSFunction(get_rotationBySpeed), null);
		L.RegVar("externalForces", new LuaCSFunction(get_externalForces), null);
		L.RegVar("noise", new LuaCSFunction(get_noise), null);
		L.RegVar("collision", new LuaCSFunction(get_collision), null);
		L.RegVar("trigger", new LuaCSFunction(get_trigger), null);
		L.RegVar("subEmitters", new LuaCSFunction(get_subEmitters), null);
		L.RegVar("textureSheetAnimation", new LuaCSFunction(get_textureSheetAnimation), null);
		L.RegVar("lights", new LuaCSFunction(get_lights), null);
		L.RegVar("trails", new LuaCSFunction(get_trails), null);
		L.RegVar("customData", new LuaCSFunction(get_customData), null);
		L.EndClass();
	}
	...
	static int Stop(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)ToLua.CheckObject<UnityEngine.ParticleSystem>(L, 1);
				bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
				UnityEngine.ParticleSystemStopBehavior arg1 = (UnityEngine.ParticleSystemStopBehavior)ToLua.CheckObject(L, 3, TypeTraits<UnityEngine.ParticleSystemStopBehavior>.type);
				obj.Stop(arg0, arg1);
				return 0;
			}
			else
	...
	static int AllocateCustomDataAttribute(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)ToLua.CheckObject<UnityEngine.ParticleSystem>(L, 1);
			UnityEngine.ParticleSystemCustomData arg0 = (UnityEngine.ParticleSystemCustomData)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.ParticleSystemCustomData>.type);
