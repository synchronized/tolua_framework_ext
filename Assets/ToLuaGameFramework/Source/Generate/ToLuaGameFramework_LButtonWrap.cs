...
public class ToLuaGameFramework_LButtonWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("param", new LuaCSFunction(get_param), new LuaCSFunction(set_param));
		L.RegVar("self", new LuaCSFunction(get_self), new LuaCSFunction(set_self));
		L.RegVar("canTriggerInterval", new LuaCSFunction(get_canTriggerInterval), new LuaCSFunction(set_canTriggerInterval));
		L.EndClass();
	}
