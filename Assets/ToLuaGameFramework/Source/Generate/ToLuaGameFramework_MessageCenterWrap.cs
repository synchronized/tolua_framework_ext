...
public class ToLuaGameFramework_MessageCenterWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", new LuaCSFunction(_CreateToLuaGameFramework_MessageCenter));
	...
	static int Add(IntPtr L)
	{
		try
		{
			...
			ToLuaGameFramework.MsgEnum arg0 = (ToLuaGameFramework.MsgEnum)ToLua.CheckObject(L, 1, TypeTraits<ToLuaGameFramework.MsgEnum>.type);
