...
public class ToLuaGameFramework_UIManagerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("SpawnUI", new LuaCSFunction(SpawnUI));
		L.RegFunction("SpawnUIAsyn", new LuaCSFunction(SpawnUIAsyn));
		L.RegFunction("ResumeUI", new LuaCSFunction(ResumeUI));
		L.RegFunction("ClearAllUI", new LuaCSFunction(ClearAllUI));
		L.RegFunction("OnUIDestroy", new LuaCSFunction(OnUIDestroy));
		L.RegFunction("RefreshStack", new LuaCSFunction(RefreshStack));
