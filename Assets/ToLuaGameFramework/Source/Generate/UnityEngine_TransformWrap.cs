...
public class UnityEngine_TransformWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("DOAlpha", new LuaCSFunction(DOAlpha));
		L.RegFunction("ClearEvent", new LuaCSFunction(ClearEvent));
		L.RegFunction("OnPressEnter", new LuaCSFunction(OnPressEnter));
		L.RegFunction("OnDown", new LuaCSFunction(OnDown));
	...
	static int DOAlpha(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				...
				float arg0 = (float)LuaDLL.luaL_checknumber(L, 2);
				float arg1 = (float)LuaDLL.luaL_checknumber(L, 3);
				DG.Tweening.Ease arg2 = (DG.Tweening.Ease)ToLua.CheckObject(L, 4, TypeTraits<DG.Tweening.Ease>.type);
			...
			else if (count == 6)
			{
				...
				float arg1 = (float)LuaDLL.luaL_checknumber(L, 3);
				float arg2 = (float)LuaDLL.luaL_checknumber(L, 4);
				DG.Tweening.Ease arg3 = (DG.Tweening.Ease)ToLua.CheckObject(L, 5, TypeTraits<DG.Tweening.Ease>.type);
				bool arg4 = LuaDLL.luaL_checkboolean(L, 6);
