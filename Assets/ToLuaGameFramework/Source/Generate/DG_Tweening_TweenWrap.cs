...
public class DG_Tweening_TweenWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("ElapsedDelay", new LuaCSFunction(ElapsedDelay));
		...
		L.RegVar("debugTargetId", new LuaCSFunction(get_debugTargetId), new LuaCSFunction(set_debugTargetId));
		...
		L.RegVar("hasLoops", new LuaCSFunction(get_hasLoops), null);
