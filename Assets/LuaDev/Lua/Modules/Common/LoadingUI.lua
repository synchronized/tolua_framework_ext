...
local LoadingUI = Class("LoadingUI", BaseUI)

function LoadingUI:PrefabPath()
    return "Prefabs/Common/LoadingUI"
end

function LoadingUI:IsFloat()
    return true
end
...
--外部调用
function LoadingUI:SetContent(text)
